        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <a href='relatorioWorkspace.php?id=<?php echo $id_usuario ?>'>Voltar</a>
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="validaEdit.php" method="POST">
                    ...
                    <div hidden class="wrap-input100 validate-input">
						<input class="input100" type="text" name="id_workspace" value="<?php echo $id_workspace; ?>">
