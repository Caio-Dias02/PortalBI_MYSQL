...
<!--===============================================================================================-->
    ...
    <title>Relatório Workspace</title>
            ...
            <div id="content">
			    ...
			    <div class="RelatorioWorkspace">
                    ...
                    <table class="table table-striped table-hover ">
                        <thead>
                            <tr>
                                <th scope="col">id_workspace</th>
                                <th scope="col">Nome do Workspace</th>
                                <th scope="col">URL do Workspace</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                                while($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                                    ...
                                    if($id_rls == 1 || $id_rls == 2 || $id_rls == 3 || $id_rls == 4 && !empty($row['id_workspace'])){   echo "<td>
                                        ...
                                        <a classe ='btn btn-sm btn-primary' href='delete.php?id=$row[id_workspace]'>
