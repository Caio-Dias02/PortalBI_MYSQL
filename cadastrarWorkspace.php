    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="validaWorkspace.php" method="POST">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="nomeWorkspace">
						<span class="focus-input100" data-placeholder="Nome do Workspace"></span>
					</div>

					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="Workspace">
