    ...
    $stmt2 = sqlsrv_query($conn, $sqlWorkspace);
        ...
        if($stmt){
            while($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                ...
                $permissao = trim(strip_tags($row['permissao']));
            }        //print_r($Workspace);
        } else {
            ...
            <div class="limiter">
                <div>
			        <div class="wrap-login100">
				        <form action="validaUsuario.php" method="POST" class="login100-form validate-form">
                            ...
                            <div hidden class="wrap-input100 validate-input">
                                <input class="input100" type="text" name="id_user" value="<?php echo $id_user; ?>">
                                <span class="focus-input100" data-placeholder="id_user"></span>
                            </div>
                            <div class="wrap-input100 validate-input">
                                <input class="input100" type="text" name="nome" value="<?php echo $nomeUsers; ?>">
